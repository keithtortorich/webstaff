...
See agents/receptionist/spec.md for full spec.
"""
import logging
import json
...
def handle(event: dict) -> dict:
    ...
    See agents/receptionist/spec.md for the full tool list and success metric.
    """
    logger.info("receptionist triggered", extra={"event_type": event.get("type")})
